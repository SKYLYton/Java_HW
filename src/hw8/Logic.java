...
public class Logic {
    ...
    public static void humanAiTurn(int x, int y) {
        if(isCellValid(y, x)){
            map[y][x] = DOT_X;
            go();
        }
    ...
    public static void humanHumanTurn(int x, int y) {
        if(isCellValid(y, x)){
            map[y][x] = goes;
            goHuman();

            goes = goes == DOT_O ? DOT_X : DOT_O;
        }
    }
